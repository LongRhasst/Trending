...
from app.api.v1.auth.schemas import SignInResponseSchema, SignInSchema, SignUpSchema, SignUpResponseSchema
...
async def login(
    ...
    try:
        # Validate that at least email or username is provided (done in schema)
